const {
  ...
  // ReadMessagesOptions, ExportDefinition,
...
c.onConnected(async () => {
  ...
  try {
    ...
    const taskDefinition = new S3ExportTaskDefinition()
      ...
      .withKey("myKeyNameSuffix")
      .withInputUrl("file:/home/ggc_user/test.txt");
      console.log(`Successfully appended message to stream with sequence number 
                    ${await c.appendMessage("StreamName", util.validateAndSerializeToJsonBytes(taskDefinition))}`);
